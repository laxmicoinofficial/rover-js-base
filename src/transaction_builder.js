 ...
 * @param {object} [opts]
 * @param {number} [opts.fee] - The max fee willing to pay per operation in this transaction (**in mint**).
...
export class TransactionBuilder {
  constructor(sourceAccount, opts={}) {
    ...
    // the signed base64 form of the transaction to be sent to Orbit
    this.blob = null;
  }
