import {default as xdr} from "./generated/rover-xdr_generated";
 ...
 * @constant
 * @see [Account flags](http://www.rover.network/developers/guides/concepts/accounts.html#flags)
 */
...
/**
 * `Operation` class represents [operations](http://www.rover.network/developers/learn/concepts/operations.html) in Rover network.
...
export class Operation {
   ...
   * @param {string} opts.startingBalance - Amount in XLX the account should be funded for. Must be greater
   *                                   than the [reserve balance amount](http://www.rover.network/developers/learn/concepts/fees.html).
   ...
   * destination account, optionally through a path. XLX payments create the destination
