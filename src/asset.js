...
/**
 * Asset class represents an asset, either the native asset (`XLX`)
 * or an asset code / issuer account ID pair.
 *
 * An asset code describes an asset code and issuer pair. In the case of the native
 * asset XLX, the issuer will be null.
 *
 * @constructor
...
export class Asset {
  constructor(code, issuer) {
    ...
    if (String(code).toLowerCase() !== "xlx" && !issuer) {
   ...
   * * `credit_alphanum12`
   *
   * @see [Assets concept](http://www.rover.network/developers/learn/concepts/assets.html)
   * @returns {string}
   */
  getAssetType() {
    if (this.isNative()) {
