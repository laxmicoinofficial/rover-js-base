 ...
 * * `Networks.PUBLIC`: `Public Global Rover Network ; September 2015`
 * * `Networks.TESTNET`: `Test SDF Network ; September 2015`
 * @type {{PUBLIC: string, TESTNET: string}}
 */
export const Networks = {
	PUBLIC: "Public Global Rover Network ; May 2018",
	TESTNET: "Rover Testnet ; April 2018"
};
 ...
 * rover networks.  It also provides the {@link Network.current} class method that returns the network
