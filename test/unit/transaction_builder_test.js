describe('TransactionBuilder', function() {
    ...
    describe("constructs a native payment transaction with one operation", function() {
        ...
        var memo;
        beforeEach(function () {
            source = new RoverBase.Account("GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ", "0");
            destination = "GDJJRRMBK4IWLEPJGIE6SXD2LP7REGZODU7WDC3I2D6MR37F4XSHBKX2";
            amount = "1000";
            asset = RoverBase.Asset.native();
            memo = RoverBase.Memo.id("100");

            transaction = new RoverBase.TransactionBuilder(source)
        ...
        it("should have 100 mint fee", function (done) {
    ...
    describe("constructs a native payment transaction with two operations", function() {
        ...
        it("should have 200 mint fee", function (done) {
    ...
    describe("constructs a native payment transaction with custom base fee", function() {
        ...
        beforeEach(function () {
            ...
            transaction = new RoverBase.TransactionBuilder(source, {fee: 1000})
              .addOperation(RoverBase.Operation.payment({
                  destination: destination1,
                  asset: asset,
                  amount: amount1
        ...
        it("should have 2000 mint fee", function (done) {
    ...
    describe("constructs a native payment transaction with timebounds", function() {
        it("should have have timebounds", function (done) {
            let source = new RoverBase.Account("GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ", "0");
            let timebounds = {
                minTime: "1455287522",
                maxTime: "1455297545"
            };
            let transaction = new RoverBase.TransactionBuilder(source, {timebounds})
              .addOperation(RoverBase.Operation.payment({
                  destination: "GDJJRRMBK4IWLEPJGIE6SXD2LP7REGZODU7WDC3I2D6MR37F4XSHBKX2",
                  asset: RoverBase.Asset.native(),
                  amount: "1000"
