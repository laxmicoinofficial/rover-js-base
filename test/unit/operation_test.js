...
describe('Operation', function() {
    ...
    describe(".createAccount()", function () {
        it("creates a createAccountOp", function () {
            ...
            let op = RoverBase.Operation.createAccount({destination, startingBalance});
            var xdr = op.toXDR("hex");
            var operation = RoverBase.xdr.Operation.fromXDR(new Buffer(xdr, "hex"));
            var obj = RoverBase.Operation.fromXDRObject(operation);
        ...
        it("fails to create createAccount operation with an invalid destination address", function () {
            ...
            expect(() => RoverBase.Operation.createAccount(opts)).to.throw(/destination is invalid/)
        });
        ...
        it("fails to create createAccount operation with an invalid startingBalance", function () {
            ...
            expect(() => RoverBase.Operation.createAccount(opts)).to.throw(/startingBalance argument must be of type String, represent a positive number and have at most 7 digits after the decimal/)
        });
        ...
        it("fails to create createAccount operation with an invalid source address", function () {
            ...
            expect(() => RoverBase.Operation.createAccount(opts)).to.throw(/Source address is invalid/)
        });
    });
    ...
    describe(".payment()", function () {
        it("creates a paymentOp", function () {
            var destination = "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ";
            var amount = "1000";
            var asset = new RoverBase.Asset("USDUSD", "GDGU5OAPHNPU5UCLE5RDJHG7PXZFQYWKCFOEXSXNMR6KRQRI5T6XXCD7");
            let op = RoverBase.Operation.payment({destination, asset, amount});
            var xdr = op.toXDR("hex");
            var operation = RoverBase.xdr.Operation.fromXDR(new Buffer(xdr, "hex"));
            var obj = RoverBase.Operation.fromXDRObject(operation);
        ...
        it("fails to create payment operation with an invalid destination address", function () {
            let opts = {
                destination: 'GCEZW',
                asset: RoverBase.Asset.native(),
                amount: '20'
            };
            expect(() => RoverBase.Operation.payment(opts)).to.throw(/destination is invalid/)
        });
        ...
        it("fails to create payment operation with an invalid amount", function () {
            ...
            expect(() => RoverBase.Operation.payment(opts)).to.throw(/amount argument must be of type String/)
        });
    });

    describe(".pathPayment()", function () {
        it("creates a pathPaymentOp", function() {
            var sendAsset = new RoverBase.Asset("USD", "GDGU5OAPHNPU5UCLE5RDJHG7PXZFQYWKCFOEXSXNMR6KRQRI5T6XXCD7");
            var sendMax = '3.007';
            var destination = "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ";
            var destAsset = new RoverBase.Asset("USD", "GDGU5OAPHNPU5UCLE5RDJHG7PXZFQYWKCFOEXSXNMR6KRQRI5T6XXCD7");
            var destAmount = '3.1415';
            var path = [
                new RoverBase.Asset('USD', 'GBBM6BKZPEHWYO3E3YKREDPQXMS4VK35YLNU7NFBRI26RAN7GI5POFBB'),
                new RoverBase.Asset('EUR', 'GDTNXRLOJD2YEBPKK7KCMR7J33AAG5VZXHAJTHIG736D6LVEFLLLKPDL')
            ];
            let op = RoverBase.Operation.pathPayment({sendAsset, sendMax, destination, destAsset, destAmount, path});
            var xdr = op.toXDR("hex");
            var operation = RoverBase.xdr.Operation.fromXDR(new Buffer(xdr, "hex"));
            var obj = RoverBase.Operation.fromXDRObject(operation);
        ...
        it("fails to create path payment operation with an invalid destination address", function () {
            let opts = {
                ...
                sendMax: '20',
                destAmount: '50',
                sendAsset: RoverBase.Asset.native(),
                destAsset: new RoverBase.Asset("USD", "GDGU5OAPHNPU5UCLE5RDJHG7PXZFQYWKCFOEXSXNMR6KRQRI5T6XXCD7")
            };
            expect(() => RoverBase.Operation.pathPayment(opts)).to.throw(/destination is invalid/)
        });
        ...
        it("fails to create path payment operation with an invalid sendMax", function () {
            ...
            expect(() => RoverBase.Operation.pathPayment(opts)).to.throw(/sendMax argument must be of type String/)
        });
        ...
        it("fails to create path payment operation with an invalid destAmount", function () {
            ...
            expect(() => RoverBase.Operation.pathPayment(opts)).to.throw(/destAmount argument must be of type String/)
        });
    });

    describe(".changeTrust()", function () {
        it("creates a changeTrustOp", function () {
            let asset = new RoverBase.Asset("USD", "GDGU5OAPHNPU5UCLE5RDJHG7PXZFQYWKCFOEXSXNMR6KRQRI5T6XXCD7");
            let op = RoverBase.Operation.changeTrust({asset: asset});
            var xdr = op.toXDR("hex");
            var operation = RoverBase.xdr.Operation.fromXDR(new Buffer(xdr, "hex"));
            var obj = RoverBase.Operation.fromXDRObject(operation);
        ...
        it("creates a changeTrustOp with limit", function () {
            let asset = new RoverBase.Asset("USD", "GDGU5OAPHNPU5UCLE5RDJHG7PXZFQYWKCFOEXSXNMR6KRQRI5T6XXCD7");
            let op = RoverBase.Operation.changeTrust({asset: asset, limit: "50"});
            var xdr = op.toXDR("hex");
            var operation = RoverBase.xdr.Operation.fromXDR(new Buffer(xdr, "hex"));
            var obj = RoverBase.Operation.fromXDRObject(operation);
            expect(obj.type).to.be.equal("changeTrust");
        ...
        it("deletes a trustline", function () {
            let asset = new RoverBase.Asset("USD", "GDGU5OAPHNPU5UCLE5RDJHG7PXZFQYWKCFOEXSXNMR6KRQRI5T6XXCD7");
            let op = RoverBase.Operation.changeTrust({asset: asset, limit: "0"});
            var xdr = op.toXDR("hex");
            var operation = RoverBase.xdr.Operation.fromXDR(new Buffer(xdr, "hex"));
            var obj = RoverBase.Operation.fromXDRObject(operation);
            expect(obj.type).to.be.equal("changeTrust");
        ...
        it("throws TypeError for incorrect limit argument", function () {
            let asset = new RoverBase.Asset("USD", "GDGU5OAPHNPU5UCLE5RDJHG7PXZFQYWKCFOEXSXNMR6KRQRI5T6XXCD7");
            let changeTrust = () => RoverBase.Operation.changeTrust({asset: asset, limit: 0});
    ...
    describe(".allowTrust()", function () {
        it("creates a allowTrustOp", function () {
            ...
            let assetCode = "USD";
            let authorize = true;
            let op = RoverBase.Operation.allowTrust({
                trustor: trustor,
                assetCode: assetCode,
                authorize: authorize
            });
        ...
        it("fails to create allowTrust operation with an invalid trustor address", function () {
            ...
            expect(() => RoverBase.Operation.allowTrust(opts)).to.throw(/trustor is invalid/)
        });
    });

    describe(".setOptions()", function () {
        it("auth flags are set correctly", function () {
            expect(RoverBase.AuthRequiredFlag).to.be.equal(1);
            expect(RoverBase.AuthRevocableFlag).to.be.equal(2);
            expect(RoverBase.AuthImmutableFlag).to.be.equal(4);
        });

        it("creates a setOptionsOp", function () {
            var opts = {};
            opts.inflationDest = "GDGU5OAPHNPU5UCLE5RDJHG7PXZFQYWKCFOEXSXNMR6KRQRI5T6XXCD7";
            opts.clearFlags = RoverBase.AuthRevocableFlag | RoverBase.AuthImmutableFlag;
            opts.setFlags = RoverBase.AuthRequiredFlag;
            opts.masterWeight = 0;
            opts.lowThreshold = 1;
            opts.medThreshold = 2;
            ...
            let op = RoverBase.Operation.setOptions(opts);
            var xdr = op.toXDR("hex");
            var operation = RoverBase.xdr.Operation.fromXDR(new Buffer(xdr, "hex"));
            var obj = RoverBase.Operation.fromXDRObject(operation);
        ...
        it("fails to create setOptions operation with an invalid setFlags", function () {
            ...
            expect(() => RoverBase.Operation.setOptions(opts)).to.throw();
        });
        ...
        it("fails to create setOptions operation with an invalid inflationDest address", function () {
            ...
            expect(() => RoverBase.Operation.setOptions(opts)).to.throw(/inflationDest is invalid/)
        });
        ...
        it("fails to create setOptions operation with an invalid signer address", function () {
            ...
            expect(() => RoverBase.Operation.setOptions(opts)).to.throw(/signer.ed25519PublicKey is invalid/)
        });
        ...
        it("fails to create setOptions operation with multiple signer values", function () {
            ...
            expect(() => RoverBase.Operation.setOptions(opts)).to.throw(/Signer object must contain exactly one/)
        });
        ...
        it("fails to create setOptions operation with an invalid masterWeight", function() {
            ...
            expect(() => RoverBase.Operation.setOptions(opts)).to.throw(/masterWeight value must be between 0 and 255/)
        });
        ...
        it("fails to create setOptions operation with an invalid lowThreshold", function() {
            ...
            expect(() => RoverBase.Operation.setOptions(opts)).to.throw(/lowThreshold value must be between 0 and 255/)
        });
        ...
        it("fails to create setOptions operation with an invalid medThreshold", function() {
            ...
            expect(() => RoverBase.Operation.setOptions(opts)).to.throw(/medThreshold value must be between 0 and 255/)
        });
        ...
        it("fails to create setOptions operation with an invalid highThreshold", function() {
            ...
            expect(() => RoverBase.Operation.setOptions(opts)).to.throw(/highThreshold value must be between 0 and 255/)
        });
        ...
        it("fails to create setOptions operation with an invalid homeDomain", function() {
            ...
            expect(() => RoverBase.Operation.setOptions(opts)).to.throw(/homeDomain argument must be of type String/)
        });
    });
    ...
    describe(".manageOffer", function () {
        it("creates a manageOfferOp (string price)", function () {
            var opts = {};
            opts.selling = new RoverBase.Asset("USD", "GDGU5OAPHNPU5UCLE5RDJHG7PXZFQYWKCFOEXSXNMR6KRQRI5T6XXCD7");
            opts.buying = new RoverBase.Asset("USD", "GDGU5OAPHNPU5UCLE5RDJHG7PXZFQYWKCFOEXSXNMR6KRQRI5T6XXCD7");
            opts.amount = '3.123456';
            opts.price = '8.141592';
            opts.offerId = '1';
            let op = RoverBase.Operation.manageOffer(opts);
            var xdr = op.toXDR("hex");
            var operation = RoverBase.xdr.Operation.fromXDR(new Buffer(xdr, "hex"));
            var obj = RoverBase.Operation.fromXDRObject(operation);
        ...
        it("creates an invalid manageOfferOp (price fraction)", function () {
            ...
            opts.offerId = '1';
            expect(() => RoverBase.Operation.manageOffer(opts)).to.throw(/price must be positive/)
        });
        ...
        it("fails to create manageOffer operation with an invalid amount", function () {
            let opts = {
                amount: 20,
                price: '10',
                selling: new RoverBase.Asset("USD", "GDGU5OAPHNPU5UCLE5RDJHG7PXZFQYWKCFOEXSXNMR6KRQRI5T6XXCD7"),
                buying: new RoverBase.Asset("USD", "GDGU5OAPHNPU5UCLE5RDJHG7PXZFQYWKCFOEXSXNMR6KRQRI5T6XXCD7")
            };
            expect(() => RoverBase.Operation.manageOffer(opts)).to.throw(/amount argument must be of type String/)
        });
        ...
        it("fails to create manageOffer operation with missing price", function () {
            ...
            expect(() => RoverBase.Operation.manageOffer(opts)).to.throw(/price argument is required/)
        });
        ...
        it("fails to create manageOffer operation with invalid price", function () {
            ...
            expect(() => RoverBase.Operation.manageOffer(opts)).to.throw(/not a number/)
        });
    });
    ...
    describe(".createPassiveOffer", function () {
        it("creates a createPassiveOfferOp (string price)", function () {
            ...
            opts.price = '3.07';
            let op = RoverBase.Operation.createPassiveOffer(opts);
            var xdr = op.toXDR("hex");
            var operation = RoverBase.xdr.Operation.fromXDR(new Buffer(xdr, "hex"));
            var obj = RoverBase.Operation.fromXDRObject(operation);
        ...
        it("fails to create createPassiveOffer operation with an invalid amount", function () {
            ...
            expect(() => RoverBase.Operation.createPassiveOffer(opts)).to.throw(/amount argument must be of type String/)
        });
        ...
        it("fails to create createPassiveOffer operation with missing price", function () {
            ...
            expect(() => RoverBase.Operation.createPassiveOffer(opts)).to.throw(/price argument is required/)
        });
        ...
        it("fails to create createPassiveOffer operation with negative price", function () {
            ...
            expect(() => RoverBase.Operation.createPassiveOffer(opts)).to.throw(/price must be positive/)
        });
    });
    ...
    describe(".accountMerge", function () {
        it("creates a accountMergeOp", function () {
            ...
            let op = RoverBase.Operation.accountMerge(opts);
            var xdr = op.toXDR("hex");
            var operation = RoverBase.xdr.Operation.fromXDR(new Buffer(xdr, "hex"));
            var obj = RoverBase.Operation.fromXDRObject(operation);
        ...
        it("fails to create accountMerge operation with an invalid destination address", function () {
            ...
            expect(() => RoverBase.Operation.accountMerge(opts)).to.throw(/destination is invalid/)
        });
    });

    describe(".inflation", function () {
        it("creates a inflationOp", function () {
            let op = RoverBase.Operation.inflation();
            var xdr = op.toXDR("hex");
            var operation = RoverBase.xdr.Operation.fromXDR(new Buffer(xdr, "hex"));
            var obj = RoverBase.Operation.fromXDRObject(operation);
    ...
    describe(".manageData", function () {
        it("creates a manageDataOp with string value", function () {
            ...
            let op = RoverBase.Operation.manageData(opts);
            var xdr = op.toXDR("hex");
            var operation = RoverBase.xdr.Operation.fromXDR(new Buffer(xdr, "hex"));
            var obj = RoverBase.Operation.fromXDRObject(operation);
        ...
        describe("fails to create manageData operation", function () {
            it("name is not a string", function () {
                expect(() => RoverBase.Operation.manageData({name: 123})).to.throw()
            });

            it("name is too long", function () {
                expect(() => RoverBase.Operation.manageData({name: "a".repeat(65)})).to.throw()
            });

            it("value is too long", function () {
                expect(() => RoverBase.Operation.manageData({name: "a", value: new Buffer(65)})).to.throw()
            });
        });
    });
    ...
    describe("._checkUnsignedIntValue()", function () {
        it("returns true for valid values", function () {
            ...
            for (var i in values) {
                ...
                expect(RoverBase.Operation._checkUnsignedIntValue(value, value)).to.be.equal(expected);
            }
        });
        ...
        it("throws error for invalid values", function () {
            ...
            for (var i in values) {
                let value = values[i];
                expect(() => RoverBase.Operation._checkUnsignedIntValue(value, value)).to.throw();
            }
        });

        it("return correct values when isValidFunction is set", function () {
            expect(
                RoverBase.Operation._checkUnsignedIntValue("test", undefined, value => value < 10)
            ).to.equal(undefined);

            expect(
                RoverBase.Operation._checkUnsignedIntValue("test", 8, value => value < 10)
            ).to.equal(8);
            expect(
                RoverBase.Operation._checkUnsignedIntValue("test", "8", value => value < 10)
            ).to.equal(8);
            ...
            expect(() => {
                RoverBase.Operation._checkUnsignedIntValue("test", 12, value => value < 10);
            }).to.throw();
            expect(() => {
                RoverBase.Operation._checkUnsignedIntValue("test", "12", value => value < 10);
            }).to.throw();
    ...
    describe(".isValidAmount()", function () {
        it("returns true for valid amounts", function () {
            ...
            for (var i in amounts) {
                expect(RoverBase.Operation.isValidAmount(amounts[i])).to.be.true;
            }
        });
        ...
        it("returns false for invalid amounts", function () {
            ...
            for (var i in amounts) {
                expect(RoverBase.Operation.isValidAmount(amounts[i])).to.be.false;
            }
        });

        it("allows 0 only if allowZero argument is set to true", function () {
            expect(RoverBase.Operation.isValidAmount("0")).to.be.false;
            expect(RoverBase.Operation.isValidAmount("0", true)).to.be.true;
        });
    });
});
