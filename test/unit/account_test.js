...
describe('Account.constructor', function() {
  it("fails to create Account object from an invalid address", function() {
    expect(() => new RoverBase.Account('GBBB')).to.throw(/accountId is invalid/);
  });

  it("fails to create Account object from an invalid sequence number", function() {
    expect(() => new RoverBase.Account('GBBM6BKZPEHWYO3E3YKREDPQXMS4VK35YLNU7NFBRI26RAN7GI5POFBB', 100)).to.throw(/sequence must be of type string/);
  });

  it("creates an Account object", function() {
    let account = new RoverBase.Account('GBBM6BKZPEHWYO3E3YKREDPQXMS4VK35YLNU7NFBRI26RAN7GI5POFBB', '100');
